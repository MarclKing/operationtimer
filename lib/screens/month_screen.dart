...
//
// HINWEIS: Der Zeitpicker in _EditSheet bleibt lokal, da er eigene Logik hat
// (_getDefaultGehenTime, kein confirmOnDismiss-Verhalten), die nicht in den
// gemeinsamen IOSTimePicker passt.
// ─────────────────────────────────────────────────────────────────────────────
      ...
      builder: (_) => _EditSheet(
        ...
        onSave: () async {
          ...
          _showSnackbar('Aktualisiert ✓',
              skin.primary == Colors.white ? const Color(0xFF3DD6C8) : skin.primary);
        },
      ),
    );
  }
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // ── Stat Cards aus glass_kit.dart ──
                    Row(children: [
                      GlassStatCard(label: 'Arbeit', value: '${entries.length}', color: skin.statEntries),
                      const SizedBox(width: 10),
                      GlassStatCard(label: 'Tage', value: '$daysInMonth', color: skin.statComplete),
                      const SizedBox(width: 10),
                      GlassStatCard(label: 'Offen', value: '$offeneEntries', color: skin.statOpen),
                    ]),
                                    ...
                                    children: [
                                      GestureDetector(
                                        onTap: () async {
                                          ...
                                          await PdfService.exportMonth(context, _selectedMonth);
                                          ...
                                          child: BackdropFilter(
                                            ...
                                            child: Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Icon(Icons.picture_as_pdf_outlined, color: skin.primary, size: 16),
        ...
        child: SizedBox(
          ...
          child: ClipRect(
            child: Stack(
              ...
              children: [
                // ── LINKS: Bearbeiten + Teilen ──
                Positioned(
                  left: 0, top: 4, bottom: 4, width: _editReveal,
                  child: Row(children: [
                    Expanded(
                            ...
                            child: BackdropFilter(
                              ...
                              child: Container(
                                ...
                                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                  ...
                                  Text('Bearbeiten', style: TextStyle(color: skin.editColor, fontSize: 11, fontWeight: FontWeight.w600)),
                                ]),
                              ),
                            ),
                          ),
                ...
                // ── RECHTS: Löschen ──
                Positioned(
                  right: 0, top: 4, bottom: 4, width: _deleteReveal,
                  child: GestureDetector(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text(dayNum,
                                            style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: skin.textPrimary, height: 1)),
                                        const SizedBox(width: 3),
                                        Text(DateFormat('MMM', 'de').format(datum),
                                            style: TextStyle(fontSize: 10, fontWeight: FontWeight.w500, color: skin.surface(0.3))),
                                      ],
                                    ),
                                    if (showNumber)
                                      Text('$entryNumber.',
                                          style: TextStyle(fontSize: 7, fontWeight: FontWeight.w600, color: skin.primary.withValues(alpha: 0.6))),
                                  ],
                                ),
                              ),
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        Text(
                                          ...
                                          style: TextStyle(fontSize: 26, fontWeight: FontWeight.w700,
                                              color: kommen.isEmpty ? skin.surface(0.2) : skin.kommenColor),
                                        ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(horizontal: 6),
                                          child: Icon(Icons.arrow_forward, size: 16, color: skin.surface(0.2)),
                                        ),
                                        Text(
                                          gehen.isEmpty ? '--:--' : gehen,
                                          style: TextStyle(fontSize: 26, fontWeight: FontWeight.w700,
                                              color: gehen.isEmpty ? skin.surface(0.2) : skin.gehenColor),
                                        ),
                                      ],
                                    ),
                                    if (tkf.isNotEmpty || hasNotiz) ...[
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          if (tkf.isNotEmpty) ...[
                                            Icon(Icons.person_outline, size: 14, color: skin.surface(0.35)),
                                            const SizedBox(width: 4),
                                            Flexible(child: Text(tkf,
                                                style: TextStyle(fontSize: 12, color: skin.surface(0.42)),
                                                maxLines: 1, overflow: TextOverflow.ellipsis)),
                                          ],
                                          if (hasNotiz) ...[
                                            if (tkf.isNotEmpty) const SizedBox(width: 8),
                                            Icon(Icons.note_outlined, size: 14, color: skin.primary.withValues(alpha: 0.45)),
                                          ],
                                        ],
                                      ),
                                    ],
...
// ─────────────────────────────────────────────────────────────────────────────
// EDIT SHEET — Glass
// Hinweis: Zeitpicker bleibt lokal (eigene _getDefaultGehenTime-Logik)
// ─────────────────────────────────────────────────────────────────────────────
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Row(children: [
                  ...
                  Text(':', style: TextStyle(fontSize: 26, fontWeight: FontWeight.w700, color: skin.primary)),
                  Expanded(
                    child: CupertinoPicker(
                  ...
                  Expanded(
                    child: GlassSecondaryButton(
                      ...
                      onTap: () {
                        ...
                        ctrl.text = '${selH.toString().padLeft(2, '0')}:${selM.toString().padLeft(2, '0')}';
                        setSheet(() {});
                      },
                    ),
                  ),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(children: [
                    Expanded(
                      child: _SwipeEditTimeField(
                        ...
                        onDoubleTap: () { setState(() => widget.kommenCtrl.clear()); HapticFeedback.selectionClick(); },
                    ...
                    Expanded(
                      child: _SwipeEditTimeField(
                        ...
                        onDoubleTap: () { setState(() => widget.gehenCtrl.clear()); HapticFeedback.selectionClick(); },
                  ...
                  const SizedBox(height: 12),
                  GestureDetector(
                    onDoubleTap: () { setState(() => widget.tkfCtrl.clear()); HapticFeedback.selectionClick(); },
                    child: _GlassTextFieldInput(label: 'TKF', ctrl: widget.tkfCtrl, capitalize: true),
                  ),
                  const SizedBox(height: 12),
                  GestureDetector(
                    onDoubleTap: () { setState(() => widget.notizCtrl.clear()); HapticFeedback.selectionClick(); },
                    child: _GlassTextFieldInput(label: 'NOTIZ', ctrl: widget.notizCtrl, maxLines: 2, capitalize: true),
                  ),
                  const SizedBox(height: 20),
                  // ── GlassPrimaryButton aus glass_kit.dart ──
                  GlassPrimaryButton(skin: skin, label: 'Speichern', onTap: widget.onSave),
                ],
              ),
            ),
          ),
...
class _SwipeEditTimeField extends StatefulWidget {
  ...
  const _SwipeEditTimeField({
    required this.label, required this.ctrl, required this.color,
    required this.onTap, this.onDoubleTap,
    required this.onSwipeUp, required this.onSwipeDown,
  });
                  ...
                  children: [
                    ...
                    FittedBox(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(fontSize: 24, fontWeight: FontWeight.w700, color: skin.textPrimary, letterSpacing: -1),
                      ),
                    ),
                    const SizedBox(height: 2),
                  ],
...
class _GlassTextFieldInput extends StatelessWidget {
  ...
  const _GlassTextFieldInput({
    ...
    this.maxLines = 1, this.capitalize = false,
  });
